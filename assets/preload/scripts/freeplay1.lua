...
function onCreate()
	...
	if songName == 'Freeplay1' then
		...
		setScrollFactor('image10', 1, 1);
          ...
          makeLuaSprite('image11', 'freeplay/pictures/frozen-bell', 877, 293)
		addLuaSprite('image11', true)
		setScrollFactor('image11', 1, 1);
            setProperty('image11.visible', false)

          makeLuaSprite('image12', 'freeplay/pictures/faded', 887, 303)
		addLuaSprite('image12', true)
		setScrollFactor('image12', 1, 1);
            setProperty('image12.visible', false)


          makeLuaSprite('image13', 'freeplay/pictures/paralyzed', 877, 273)
		addLuaSprite('image13', true)
		setScrollFactor('image13', 1, 1);
            setProperty('image13.visible', false)

          makeLuaSprite('image14', 'freeplay/pictures/recurrence', 877, 273)
		addLuaSprite('image14', true)
		setScrollFactor('image14', 1, 1);
            setProperty('image14.visible', false)
...
function onUpdate()
	if songName == 'Freeplay1' then
		...
		if keyboardJustPressed('UP') or keyboardJustPressed('DOWN') then
			...
			if ProductSelected == 1 then
                 ...
                 elseif ProductSelected == 11 then
                        ...
                        setProperty('image13.visible', false)
                        setProperty('image14.visible', false)
                elseif ProductSelected == 12 then
                        setProperty('song.visible', false)
                        setProperty('song1.visible', false)
                        setProperty('song2.visible', false)
                        setProperty('song3.visible', false)
                        ...
                        setProperty('image9.visible', false)
                        setProperty('image10.visible', false)
                        setProperty('image11.visible', true)
                        setProperty('image12.visible', false)
                        setProperty('image13.visible', false)
                        setProperty('image14.visible', false)
                elseif ProductSelected == 13 then
                        setProperty('song.visible', false)
                        setProperty('song1.visible', false)
                        setProperty('song2.visible', false)
                        setProperty('song3.visible', false)
                        ...
                        setProperty('image10.visible', false)
                        setProperty('image11.visible', false)
                        setProperty('image12.visible', true)
                        setProperty('image13.visible', false)
                        setProperty('image14.visible', false)
                elseif ProductSelected == 14 then
                        setProperty('song.visible', false)
                        setProperty('song1.visible', false)
                        setProperty('song2.visible', false)
                        setProperty('song3.visible', false)
                        ...
                        setProperty('image11.visible', false)
                        setProperty('image12.visible', false)
                        setProperty('image13.visible', true)
                        setProperty('image14.visible', false)
                elseif ProductSelected == 15 then
                        setProperty('song.visible', false)
                        setProperty('song1.visible', false)
                        setProperty('song2.visible', false)
                        setProperty('song3.visible', false)
                        ...
                        setProperty('image12.visible', false)
                        setProperty('image13.visible', false)
                        setProperty('image14.visible', true)
			end
		...
		if ProductSelected == 1 and keyboardJustPressed('SPACE') then
            ...
            elseif ProductSelected == 11 and keyboardJustPressed('SPACE') then
                    loadSong('steep-slopes');
            elseif ProductSelected == 12 and keyboardJustPressed('SPACE') then
                    loadSong('frozen-bell');
            elseif ProductSelected == 13 and keyboardJustPressed('SPACE') then
                    loadSong('faded');
            elseif ProductSelected == 14 and keyboardJustPressed('SPACE') then
                    loadSong('paralyzed');
            elseif ProductSelected == 15 and keyboardJustPressed('SPACE') then
                    loadSong('recurrence');
		  end
          end
        end
...
function onTimerCompleted(tag, loops, loopsLeft)
	if keyJustPressed('pause') and songName == 'Freeplay1' then
		exitMenu();
	end
end
